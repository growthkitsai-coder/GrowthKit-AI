...
const SYSTEM = [
  ...
  'The action layer must react to today\'s evidence: exactly three prioritized moves, one relevant founder worth learning from today, and one prompt for the most relevant GrowthKit tool.',
  ...
  '  "next_moves": [{ "priority": 1|2|3, "action": string, "because": string }],',
  ...
  '}',
  'Keep arrays short: 0-4 movement items, only connected own metrics, 0-3 market signals, exactly 3 next moves, 2-6 sources. No markdown.'
].join('\n');
