...
- **Product access (updated 2026-07-19):** everyone may create an account and buy Pro. Only emails in the private Vercel `GK_BETA_EMAILS` allowlist receive free Pro-equivalent beta access. Matching trims/lowercases; `GK_BETA_ENABLED=0` halts free beta immediately. Every eligible account gets one company, one full report, then ongoing daily briefs in `/four` on a UTC/GMT day boundary. New full-report gaps and daily findings include concrete weekly moves plus persistent generated/custom task checklists. Never put the allowlist or customer PII in this public repo.
